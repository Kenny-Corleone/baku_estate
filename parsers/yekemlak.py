...
SOURCE = 'yekemlak'
SOURCE_NAME = 'YekEmlak.az'
BASE_URL = 'https://yekemlak.az'
...
def _parse_card(card):
    ...
    title_el = card.select_one('h2') or card.select_one('h3') or card.select_one('.entry-title')
